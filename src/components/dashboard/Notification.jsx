...
const notifications = [
  ...
  },
  {
    ...
    details: "Se ha modificado el número de teléfono y la dirección de contacto",
    time: "9 horas",
    avatar: "https://via.placeholder.com/50"
  },
];
    ...
    <div >
      <div>
        <div className="level is-mobile">
          ...
          <p className="subtitle is-6">En esta sección puedes gestionar las notificaciones y solicitudes del distrito</p>
        </div>
          </div>
        ...
        <div className="tabs is-boxed">
          <ul>
            <li className={activeTab === "notificaciones" ? "is-active" : ""}>
              <a onClick={() => handleTabChange("notificaciones")}>Notificaciones</a>
            </li>
