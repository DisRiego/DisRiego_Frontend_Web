...
const ModalEditarCultivo = ({ isOpen, onClose, cultivoData, onSave }) => {
  const [cultivo, setCultivo] = useState(cultivoData || { nombre: "", tiempo: "", intervalo: "" });
    ...
    <div className="modal is-active">
      ...
      <div className="modal-card">
        <header className="modal-card-head">
          <p className="modal-card-title">Modificar tipo de cultivo</p>
