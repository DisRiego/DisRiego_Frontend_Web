...
const Change_status_certificate = ({
  ...
  useEffect(() => {
    setFormData({
      new_status: typeForm === "habilitar" ? 22 : 23,
    });
  }, [typeForm, id]);
    ...
    try {
      ...
      const response = await axios.patch(
        import.meta.env.VITE_URI_BACKEND +
          ...
          id +
          import.meta.env.VITE_ROUTE_BACKEND_COMPANY_CERTIFICATE_CHANGE_STATSUS,
        formData,
        {
          headers: {
      ...
      if (typeForm === "habilitar") {
        ...
        setMessage("Se ha habilitado el certificado correctamente.");
        setStatus("is-true");
        setShowMessage(true);
      } else {
        setTitleMessage("Inhabilitación exitosa");
        setMessage("Se ha inhabilitado el certificado correctamente.");
        setStatus("is-true");
        setShowMessage(true);
      }
      ...
      if (typeForm === "habilitar") {
        ...
        setMessage(
          "No se pudo habilitar el certificado. Por favor, inténtelo de nuevo."
        );
        setStatus("is-false");
      } else {
        setTitleMessage("Inhabilitación fallida");
        setMessage(
          "No se pudo inhabilitar el certificado. Por favor, inténtelo de nuevo."
        );
        setStatus("is-false");
      }
